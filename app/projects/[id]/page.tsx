  ...
  return (
    <main className="min-h-screen bg-gray-950 py-20 text-gray-100">
      <div className="mx-auto max-w-4xl px-6">
        <Link href="/" className="mb-10 inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300">
          <span aria-hidden>←</span> Back to projects
        </Link>

        <h1 className="mb-6 text-4xl font-bold text-white md:text-5xl">{project.title}</h1>
        <p className="mb-10 text-lg leading-relaxed text-gray-400">{project.description}</p>

        <div className="mb-12 grid gap-6 md:grid-cols-2">
          {project.images.map((image) => (
            <div key={image.src} className="overflow-hidden rounded-2xl border border-gray-800 bg-gray-900">
        ...
        <section className="rounded-2xl border border-gray-800 bg-gray-900 p-8">
          <h2 className="mb-5 text-2xl font-semibold text-white">Project Highlights</h2>
